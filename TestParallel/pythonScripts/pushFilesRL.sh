...
export nrnivLocation="/home/ucgbpgl/nrn62/x86_64/bin/nrniv"
...
echo "mpirun -map localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost:localhost "$nrnivLocation" "$simDir"/"$projName".hoc">runmpi.sh
...
ssh $remoteUser@$remoteHost "cd $simDir;nrnivmodl"
ssh $remoteUser@$remoteHost "cd $simDir;./runmpi.sh"
